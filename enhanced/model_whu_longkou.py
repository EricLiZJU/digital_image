...
file_path = '../../root/data/HSI_dataset/Matlab_data_format/Matlab_data_format/WHU-Hi-LongKou/WHU_Hi_LongKou.mat'

# 加载高光谱图像
hyperspec = loadmat(file_path)
data = hyperspec['WHU_Hi_LongKou']  # shape: (1217, 303, 274)

# 转置为 (H, W, C)
data = np.transpose(data, (1, 2, 0))  # (303, 274, 1217)

# 加载标签
gt = loadmat('../../root/data/HSI_dataset/Matlab_data_format/Matlab_data_format/WHU-Hi-LongKou/WHU_Hi_LongKou_gt.mat')
label_map = gt['WHU_Hi_LongKou_gt']  # shape = (2517, 2335)
