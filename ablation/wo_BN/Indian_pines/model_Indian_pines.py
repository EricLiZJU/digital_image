...
def train_and_evaluate(run_seed=42, dataset_name="Indian_pines"):
    set_seed(run_seed)
    data_path = '../../root/data/HSI_dataset/Indian_pines/Indian_pines_corrected.mat'
    label_path = '../../root/data/HSI_dataset/Indian_pines/Indian_pines_gt.mat'
