...
def train_and_evaluate(run_seed=42, dataset_name="whu_hanchuan"):
    set_seed(run_seed)
    ...
    data = hyperspec['WHU_Hi_HanChuan']  # shape: (1217, 303, 274)
    data = np.transpose(data, (1, 2, 0))  # (303, 274, 1217)
    gt = loadmat(label_path)
    label_map = gt['WHU_Hi_HanChuan_gt']  # shape = (2517, 2335)
