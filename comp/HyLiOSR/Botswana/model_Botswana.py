...
def train_and_evaluate_hyliosr(run_seed=42,
    ...
    fig_path = os.path.join(log_root, f"{dataset_name}_HyLiOSR_run{run_seed}_vis.png")
    fig_path_pdf = os.path.join(log_root, f"{dataset_name}_HyLiOSR_run{run_seed}_vis.pdf")
